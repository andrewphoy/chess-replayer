...
e+";'></td>";f+="</tr>"}f+="</table>";this.h.addClass("chess-replayer");a.html(f);!this.b.boardOnly&&!this.b.hideAnnotations&&this.a.M&&(a=8*b,l('<canvas id="'+(this.c.id+"canv")+'" height="'+a+'" width = "'+a+'"></canvas>').appendTo(this.l()).css({width:a,height:a}));this.fa().html('<a class="start button" href="#">|< Start</a><a class="back button" href="#"><< Back</a><a class="flip button" href="#">Flip</a><a class="next button" href="#">Next >></a><a class="end button" href="#">End >|</a>')},
