...
function q(a,b){this.c=a;this.c.id||(this.c.id="cr"+Math.random().toString(36).substring(5));this.i=m(a);this.options=b;this.Y=this.i.data("replayer-options");this.a={headers:[],result:"",e:0,g:1,z:"",C:0,position:[],Xa:0,U:-1,K:-1,Q:j,f:[]};this.d={n:j,Z:0,k:0,direction:-1}}
...
Qa:/^[KQBNR]([a-h])?([1-8])?x?[a-h][1-8]/,ha:/^([a-h])([1-8])/,ga:/^([a-h])x([a-h])([1-8])/,ia:/=([QBNR])/},w:{Va:[-16,-1,1,16],Ga:[-33,-31,-18,-14,14,18,31,33],qa:[-17,-15,15,17],Ua:[-17,-15,15,17,-16,-1,1,16],Fa:[-17,-16,-15,-1,1,15,16,17]},Ca:function(){this.T=m.extend({},this.options,this.Y);this.b=m.extend({},this.D,this.options,this.Y);this.ta();this.Na();this.Sa();this.Ta();this.pa();this.Ka();this.oa()},oa:function(){var a=this;this.i.keydown(function(b){return 39==b.which?(a.H(),j):37==b.which?
(a.A(),j):40==b.which&&a.d.n?(b.preventDefault(),a.Ia(),j):38==b.which&&a.d.n?(b.preventDefault(),a.Ja(),j):70==b.which?(a.N(),j):83==b.which||36==b.which||72==b.which?(a.ba(),j):69==b.which||35==b.which?(b.ctrlKey?a.G():a.$(),j):27==b.which?(a.L(),j):h});m(".board,.moves",this.c).bind("mousewheel DOMMouseScroll",function(b){var c=j;(c=0<(-b.originalEvent.detail||b.wheelDelta||b.originalEvent.wheelDelta)?a.A():a.H())&&b.preventDefault();return!c&&a.b.scrollOnEnd});m(".next",this.c).click(function(){a.H();
return j});m(".back",this.c).click(function(){a.A();return j});m(".start",this.c).click(function(){a.ba();return j});m(".flip",this.c).click(function(){a.N();return j});m(".end",this.c).click(function(){a.G();return j});m(".move",this.c).click(function(){var b=this.id.substring(a.c.id.length+4);"-end"==b?a.G():a.ca(b);return j})},ta:function(){this.b.size=this.b.size.toLowerCase();"small"!=this.b.size&&"large"!=this.b.size&&(this.b.size="medium")},O:function(){return"small"==this.b.size?this.shift.left.v:
...
c[1]);d=-1;c=/(\d+)(\.+)/.exec(b);c!=i&&(d=2*c[1],"."==c[2]&&(d-=1));0<d&&this.M(a,0,d,b);this.a.f=a.r},Ra:function(){var a={r:[],e:0};a.r[0]=new p(0,i,i,-1,"",i,i);return a},Ha:function(a){for(var b=0,c=h,d=/\(([^(]*?)\)/g;c;)a.match(d)&&(a=a.replace(d,"%%"+b+"% $1 %"+b+"%%")),c=j,a.match(d)&&(c=h,b+=1);return a},M:function(a,b,c,d){for(var e=this.R(c),f=RegExp("%%(\\d+)%\\s*"+e+"\\s*(\\w\\S+)"+this.h.ma+"(?:\\s+(.*?))?%\\1%%","g"),g,l;(g=f.exec(d))!==i;){l=m.trim(g[2]);var k="",n="";g[3]&&(n=m.trim(g[3]));
if(g[4]){for(k=m.trim(g[4]);"{"===k.charAt(0);)k=k.substr(1);for(;"}"===k.charAt(k.length-1);)k=k.slice(0,-1);0<k.length&&(this.a.Q=h)}a.e++;a.r[a.e]=new p(a.e,e.replace(/\\/g,""),l,b,k,n,c);a.r[b].children.push(a.e);g=g[5];g!=i&&(g=m.trim(g),0<g.length&&isNaN(g.charAt(0))&&(g=this.R(c+1).replace(/\\/g,"")+" "+g),this.M(a,a.e,c+1,g))}d=d.replace(f,"");g=RegExp("(?:^|\\s+)"+e+"\\s*(\\w\\S+)"+this.h.ma+"(?:\\s+(.*)|($))","m").exec(d);if(g!=i){l=m.trim(g[1]);n=k="";g[2]&&(n=m.trim(g[2]));if(g[3]){for(k=
m.trim(g[3]);"{"===k.charAt(0);)k=k.substr(1);for(;"}"===k.charAt(k.length-1);)k=k.slice(0,-1);0<k.length&&(this.a.Q=h)}a.e++;a.r[a.e]=new p(a.e,e.replace(/\\/g,""),l,b,k,n,c);a.r[b].children.push(a.e);g=g[4];g!=i&&(g=m.trim(g),0<g.length&&isNaN(g.charAt(0))&&(g=this.R(c+1).replace(/\\/g,"")+" "+g),this.M(a,a.e,c+1,g))}},R:function(a){var b=Math.ceil(a/2).toString(),c="\\.";0==a%2&&(c="\\.\\.\\.");return b+c},Ma:function(){if(this.na(this.b.fen)){for(var a=this.b.fen.split(" "),b=a[0].split("/"),
c=112,d=0,e=0;8>e;e++){for(var f=d=0;8>f;f++){var g=b[e].charAt(d);if(g!=i&&isNaN(g)){var l=g.toLowerCase()==g?"b":"w";this.a.position[c+f]=l+g.toLowerCase();"k"==g.toLowerCase()&&("w"==l?this.a.U=c+f:this.a.K=c+f)}else f+=+g-1;d++}c-=16}"b"==a[1]&&(this.a.g=-1)}},Sa:function(){this.i.empty();this.i.attr("tabindex",-1);0==this.s().size()&&this.i.append('<div class="board"></div>').css({position:"relative"});this.b.boardOnly||0==this.l().size()&&this.i.append('<div class="moves"></div>');this.b.hideControls||
...
";'></td>";f+="</tr>"}f+="</table>";this.i.addClass("chess-replayer");a.html(f);this.V().html('<a class="start button" href="#">|< Start</a><a class="back button" href="#"><< Back</a><a class="flip button" href="#">Flip</a><a class="next button" href="#">Next >></a><a class="end button" href="#">End >|</a>')},pa:function(){for(var a=this.q(),b=this.s(),c=this.O(),d=this.P(),e=7;0<=e;e--)for(var f=0;7>=f;f++){var g=16*e+f,l=this.a.position[g];if(l!=i){g=this.c.id+g;b.append("<div id='"+g+"' class='"+
l+"-"+this.b.size+" chess-piece'></div>");var l=a*(7-e)+d,k=a*f+c;m("#"+g).css({position:"absolute",top:l,left:k,height:a+"px",width:a+"px"})}}},N:function(){var a=this.q(),b=this.s(),c=7*a,d=this.O(),e=this.P(),f,g,l,k,n=this,r=setInterval(function(){m(".chess-piece",b).is(":animated")||(clearInterval(r),b.children(".chess-piece").each(function(){f=parseInt(m(this).css("top"),10)-e;g=parseInt(m(this).css("left"),10)-d;k=c-g+d;l=c-f+e;m(this).css({position:"absolute",top:l,left:k})}),n.d.direction*=
-1)},100)},Ka:function(){var a=j;this.b.startFlipped&&(a=h);if(!("startFlipped"in this.T)){-1==this.a.g&&(a=h);var b=this.getHeader("StartFlipped");b!=i&&(a="true"==b.toLowerCase()||"1"==b?h:j)}var b=0,c="startPly"in this.T?parseInt(this.T.startPly,10):parseInt(this.getHeader("StartPly"),10);c!=i&&0<c&&(b=c);a&&this.N();if(0<b&&(c=this.a.f[0],this.a.f[c.children[c.children.length-1]].S<b))for(a=0;c!=i&&0<c.children.length&&a<b;)a=c.children[c.children.length-1],this.F(a),c=this.a.f[a],a=c.S},ba:function(){for(;0<
this.a.C;)this.A()},ca:function(a){a=parseInt(a,10);if(a!=i&&a!=this.a.e){for(var b=[this.a.e],c=this.a.f[this.a.e];0<=c.m;)b.unshift(c.m),c=this.a.f[c.m];for(var d=[a],c=this.a.f[a];0<=c.m;)d.unshift(c.m),c=this.a.f[c.m];for(var c=0,e=Math.min(b.length,d.length),f=0;f<e&&b[f]==d[f];f++)c=b[f];for(;this.a.e>c;)this.A();if(this.a.e!=a)for(;this.a.e<a;)this.F(d[f]),f++}},G:function(){this.ca(this.a.f.length-1)},$:function(){for(var a=this.a.f[this.a.e];a!=i&&0<a.children.length;)a=a.children[a.children.length-
1],this.F(a),a=this.a.f[a]},H:function(){var a=this.a.f[this.a.e];if(0==a.children.length)return j;if(1==a.children.length||this.d.n){var b=a.children[a.children.length-1];this.d.n&&(b=a.children[this.d.k],this.L());this.F(b)}else this.xa(a);return h},L:function(){this.d.n&&(this.d.n=j,m(".modal li",this.c).unbind("click"),m(".modal",this.c).remove(),this.i.focus())},xa:function(a){for(var b=a.children.length,c="",c='<div class="modal"><ul>',d=b-1;0<=d;d--)c+='<li class="'+d+'">'+this.a.f[a.children[d]].o(h)+
"</li>";this.s().append(c+"</ul></div>");a=8*this.q();m(".modal",this.c).css({top:10,left:a+20});var e=this;m(".modal li",this.c).click(function(a){a=parseInt(m(a.target).attr("class"),10);e.d.k=a;e.H()});this.d.n=h;this.d.k=b-1;this.d.Z=b;m(".modal ."+this.d.k,this.c).toggleClass("selected")},Ja:function(){this.d.k+1>=this.d.Z||(this.d.k++,m(".modal .selected",this.c).toggleClass("selected"),m("."+this.d.k,".modal").toggleClass("selected"))},Ia:function(){0>=this.d.k||(this.d.k--,m(".modal .selected",
this.c).toggleClass("selected"),m("."+this.d.k,".modal").toggleClass("selected"))},F:function(a){if(a!=i){var b=this.a.f[a];this.la(b);this.W(b,1);this.a.C++;this.a.e=a;this.a.g*=-1}},A:function(){if(this.d.n)return this.L(),h;if(0<this.a.C){var a=this.a.f[this.a.e],b=a.m;this.la(this.a.f[b]);this.W(a,-1);this.a.C--;this.a.e=b;this.a.g*=-1;return h}return j},la:function(a){this.Wa(a.ua);m(".active",this.c).toggleClass("active");var b=m("#"+this.c.id+"move"+a.I.toString());b.toggleClass("active");
...
e=(1==this.a.g?"w":"b")+a.toLowerCase(),f=[],g,l,k=0;k<d.length;k++){l=d[k];for(g=b+l;!(g&136);){if(this.a.position[g]!=i){this.a.position[g]==e&&f.push(g);break}g+=l;if(!c)break}}return f},Aa:function(a){if(this.h.sa.test(a.move)){var a=1==this.a.g?0:7,b=16*a+4,a=16*a;return["m:"+b.toString()+":"+(b-2).toString(),"m:"+a.toString()+":"+(a+3).toString()]}if(this.h.ra.test(a.move))return a=1==this.a.g?0:7,b=16*a+4,a=16*a+7,["m:"+b.toString()+":"+(b+2).toString(),"m:"+a.toString()+":"+(a-2).toString()];
...
if(e!==i){d=e;0>c&&(e*=-1);for(var c=b+e,f=j;!(c&136);){if(this.a.position[c]!=i)if(c==a)f=h;else{if(f){e=this.a.position[c];c=e.charAt(1);if(e.charAt(0)!=(1==this.a.g?"b":"w"))break;return 15==d||17==d?"q"==c||"b"==c:"r"==c||"q"==c}break}c+=e}}return j},W:function(a,b){if(0<b){if(a.j==i||0==a.j.length){var c=this.Aa(a);this.a.f[a.I].j=c;a.j=c}this.a.z="";for(c=0;c<a.j.length;c++){var d=a.j[c],d=d.split(":");switch(d[0]){case "m":this.aa(d[1],d[2]);break;case "a":this.B(d[1],d[2]);break;case "r":this.J(d[1]);
break;case "e":this.a.z=d[1];break;case "p":this.J(d[2]),this.B(d[1],d[3]+d[4])}}}else if(0>b){if(a.j==i)return j;d=this.a.f[a.m];if(d!=i&&d.j!=i){for(var e=j,c=0;c<d.j.length;c++)"e"==d.j[c].charAt(0)&&(e=h,this.a.z=parseInt(d.j[c].charAt(2),8));e||(this.a.z="")}for(c=a.j.length-1;0<=c;c--)switch(d=a.j[c],d=d.split(":"),d[0]){case "m":this.aa(d[2],d[1]);break;case "a":this.J(d[1]);break;case "r":this.B(d[1],d[2]);break;case "p":this.J(d[1]),this.B(d[2],d[3]+"p")}}},B:function(a,b){var c=this.c.id+
a;this.s().append("<div id='"+c+"' class='"+b+"-"+this.b.size+" chess-piece'></div>");var d=this.q(),e=Math.floor(a/16),f=a%16;-1==this.d.direction?e=7-e:f=7-f;e=d*e+this.P();f=d*f+this.O();m("#"+c).css({position:"absolute",top:e,left:f,height:d+"px",width:d+"px"});this.a.position[a]=b},J:function(a){m("#"+(this.c.id+a)).remove();this.a.position[a]=i},aa:function(a,b){var c=this.c.id+a,d=this.c.id+b,e=this.q(),f=(Math.floor(b/16)-Math.floor(a/16))*e*this.d.direction,e=(a%16-b%16)*e*this.d.direction;
m("#"+c).animate({top:"+="+f+"px",left:"+="+e+"px"},"fast");m("#"+c).attr("id",d);c=this.a.position[a];this.a.position[b]=c;this.a.position[a]=i;"wk"===c&&(this.a.U=b);"bk"===c&&(this.a.K=b)}};q.D=q.prototype.D;m.fn.ka=function(a){return this.each(function(){(new q(this,a)).Ca()})};jQuery.prototype.replayer=m.fn.ka;m.fn.ka.defaults=q.D;})()