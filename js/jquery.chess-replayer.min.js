...
function q(a,b){this.c=a;this.c.id||(this.c.id="cr"+Math.random().toString(36).substring(5));this.i=m(a);this.options=b;this.Y=this.i.data("replayer-options");this.a={headers:[],result:"",e:0,g:1,z:"",C:0,position:[],U:-1,K:-1,Q:j,f:[]};this.d={n:j,Z:0,k:0,direction:-1}}
